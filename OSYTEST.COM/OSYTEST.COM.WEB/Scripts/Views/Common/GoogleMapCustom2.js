...
var directionsService = new google.maps.DirectionsService();
    ...
    var arrDirectionsDisplay = new Array(); //도로,도보,자전거길,정류장 경로 배열
            ...
            case "spot":
                ...
                if (option.length > 0) {
                    for (var s = 0; s < option.length; s++) {
                        ...
                        arrSpotInfo.push({ "position": tmpPos, "title": option[s]["title"], "content": option[s]["content"], "contentFun": option[s]["contentFun"], "imageIcon": option[s]["imageIcon"], "image": option[s]["image"], "imagenm": option[s]["imagenm"] });
                        arrPos.push(tmpPos);
                    }
                }
                else {
